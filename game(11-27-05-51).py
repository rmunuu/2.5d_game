...
play_img = pygame.transform.scale(pygame.image.load('./img/play.png').convert_alpha(), button_scale)
rect_play = play_img.get_rect()
tutorial_img = pygame.transform.scale(pygame.image.load('./img/tutorial.png').convert_alpha(), button_scale)
rect_tutorial = tutorial_img.get_rect()
tuto_img = pygame.transform.scale(pygame.image.load('./img/tuto.png').convert_alpha(), (DISPLAYSURF.get_height(), DISPLAYSURF.get_height()))
...
m1 = pygame.transform.scale(pygame.image.load('./img/minimap_1.png').convert_alpha(), (300, 100))
m2 = pygame.transform.scale(pygame.image.load('./img/minimap_2.png').convert_alpha(), (300, 100))
# m3 = pygame.transform.scale(pygame.image.load('./img/minimap3.png').convert_alpha(), (300, 100))
# m4 = pygame.transform.scale(pygame.image.load('./img/minimap4.png').convert_alpha(), (300, 100))
...
class Screen:
    ...
    def minimap(self):
        ...
        if idx == 0: DISPLAYSURF.blit(reddot, (DISPLAYSURF.get_width() - 310 + (self.posx - 100)*300/250, 10 + (self.posy - 175)*300/125))
...
npc1 = NPC(human1, 290, 295, "Hello!", {"Axe": Bottle})
...
def game():
    ...
    global gamestarttime, inputid, humanImage
...
def inputid():  # inputid 가 최종 입력된 사용자 id
    ...
    while True:
        ...
        inputid = ''.join(sli)
        screen.text(inputid, 60, 500, 400)
